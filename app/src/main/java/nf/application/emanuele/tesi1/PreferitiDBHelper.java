...
public class PreferitiDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("INSERT INTO eventi (eventiTitolo, eventiData, eventiLuogo, eventiDescrizione) VALUES ('Ben Ottewell', '17/10/18 21:00', 'Teatro Bloser', 'Il famoso cantautore britannico ed il suo Indie Rock finalmente live nella nostra città.')");
        ...
        db.execSQL("INSERT INTO eventi (eventiTitolo, eventiData, eventiLuogo, eventiDescrizione) VALUES ('Luca Carboni', '16/10/18 21:00', 'Teatro Politeama Genovese', 'Luca Carboni ora in tour con il suo nuovo album Pop Up riproponendo in chiave elettronica il suo repertorio.')");
